...
_G.packer_plugins = {
  ...
  coq_nvim = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/coq_nvim",
  ...
  ["nvim-lspconfig"] = {
    after = { "vim-illuminate", "nvim-lsp-installer", "fidget.nvim", "lua-dev.nvim", "schemastore.nvim", "null-ls.nvim", "nvim-lsp-ts-utils" },
